...
function App() {
  ...
  const navBox = (text, fn) => {
    return <div onClick={() => fn(true)} className={`px-3 md:w-[145px] w-[110px] py-1.5 whitespace-nowrap flex items-center justify-center rounded-sm bg-white/20 text-[#2FA5E7] md:text-lg text-sm tracking-wider`}>{text}</div>
        ...
        <section className="py-6 w-full relative">
          ...
          <div className="w-[88%] flex md:flex-row gap-6 flex-col mx-auto justify-between md:items-center">
            ...
            <div className="flex gap-4">
              <img className={`h-12 rounded-full ${imageMove ? 'move-image' : 'rotate-anime'}`} src="./leo.jpg" alt="pic" />
            ...
            <div className="md:gap-6 gap-2 flex">
